...
public class CommentService {
    ...
    //댓글 작성
    public long createComment(Long userIdx, PostCommentReq commentReq){
        long commentIdx = commentRepository.createComment(userIdx, commentReq);
...
//        if(!commentRepository.checkCommentExistts(commentIdx))
        if(commentRepository.checkUserEqual(commentIdx, userIdxByJWT))
